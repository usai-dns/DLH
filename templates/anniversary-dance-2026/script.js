...
// ---- DLH card config ----
// The portal/serving worker injects window.__CARD_CONFIG__ before this
// script loads. With no injection the card renders its defaults.
const DEFAULT_CONFIG = {
  intro_text: 'I have something for you...',
  card_title: 'Happy Anniversary,\nMy Love',
  card_message: 'I love your body,\nmoving with my body\u2026',
  main_photo: 'assets/images/main-cut.png',
  dance_styles: ['tango', 'salsa', 'ballroom', 'swing', 'hiphop', 'country'],
};
...
const DANCE_STYLES = {
  tango: {
    ...
    text: '#ffd700',
    audio: 'assets/music/tango.mp3',
  },
  salsa: {
    name: 'Salsa',
    color: '#FF6B2B',
    darkColor: '#B84A1E',
    image: 'assets/images/latin.jpg',
    bgPos: 'center top',
    overlay: 'linear-gradient(135deg, rgba(100,20,0,0.55), rgba(255,87,34,0.35))',
    text: '#ffffff',
    audio: 'assets/music/Salsa.mp3',
  },
  ballroom: {
    name: 'Ballroom',
    color: '#D4A017',
    ...
    text: '#fff8dc',
    audio: 'assets/music/ballroom.mp3',
  },
  swing: {
    name: 'Swing',
    color: '#00A878',
  ...
  country: {
    ...
    text: '#d0f0ff',
    audio: 'assets/music/country.mp3',
  },
};
